...
const HiddenGemDetail = lazy(() => import('./pages/HiddenGemDetail'));
const TravelGuide = lazy(() => import('./pages/TravelGuide'));
const Account = lazy(() => import('./pages/Account'));
const VerifyEmail = lazy(() => import('./pages/VerifyEmail'));
const Community = lazy(() => import('./pages/Community'));
const CommunityPost = lazy(() => import('./pages/CommunityPost'));
// The admin panel is its own chunk: public visitors never download it.
const AdminRoot = lazy(() => import('./admin/AdminRoot'));

export default function App() {
  return (
    <Routes>
      <Route path="admin/*" element={<ErrorBoundary resetKey="admin"><Suspense fallback={<PageLoader />}><AdminRoot /></Suspense></ErrorBoundary>} />
      <Route element={<MainLayout />}>
        ...
        {/* Gold prices were removed in v5; keep old links working. */}
        <Route path="gold" element={<Navigate to="/markets" replace />} />
        ...
        <Route path="hidden-gems/:slug" element={<HiddenGemDetail />} />
        <Route path="travel-guide" element={<TravelGuide />} />
        <Route path="community" element={<Community />} />
        <Route path="community/c/:slug" element={<Community />} />
