...
import { ZONES, destinations, getDestination, provinces } from '../data/nepalPlaces';
  ...
  return (
    <div ref={ref} data-domain="nepal">
      <section className="page-hero">
        <SmartImage photo={getDestination('pokhara').photos[1]} priority sizes="100vw" className="page-hero-img" />
