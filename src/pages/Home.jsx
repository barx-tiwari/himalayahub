...
import { WeatherWidget, NewsWidget, GoldWidget, NepseWidget, FootballWidget, CricketWidget, CryptoWidget, DateWidget } from '../components/widgets/LiveWidgets';
...
import { HERO_PHOTO, getDestination, destinations } from '../data/nepalPlaces';
...
const DISCOVER = ['pokhara', 'everest', 'mustang', 'rara', 'chitwan', 'lumbini'];
  ...
  return (
    <section className="home-hero" ref={ref} aria-labelledby="hero-title">
      ...
      <div className="container hero-content">
        ...
        <h1 id="hero-title">One place to learn, explore Nepal and stay connected with the world.</h1>
    ...
    <div className="home" ref={rootRef}>
      ...
      <Section id="today" title="Today in Nepal" lead="Weather, headlines, markets and matches — each card shows when it was last updated." className="hs-today" tone="panel">
        ...
        <div className="tin-grid">
          <WeatherWidget {...tinProps} /><NewsWidget {...tinProps} /><GoldWidget {...tinProps} /><NepseWidget {...tinProps} />
      ...
      <Section id="markets" title="Market pulse" lead="NEPSE, gold, crypto and currency. May be delayed; not financial advice." className="hs-markets" tone="panel" action={<More to="/markets">Markets</More>}>
        <div className="mkt-grid">
          <NepseWidget className="mkt-card" linkLabel="View details →" />
          <GoldWidget className="mkt-card" linkLabel="View details →" />
          <MarketCrypto />
          <MarketCurrency />
        </div>
      </Section>
