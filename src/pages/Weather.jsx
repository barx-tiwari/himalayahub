...
import { destinations, getCity, getDestination, getProvince, provinces, weatherCities, slugify } from '../data/nepalPlaces';
...
export default function Weather() {
  ...
  const dest = destinations.find((d) => d.id === place?.id);
