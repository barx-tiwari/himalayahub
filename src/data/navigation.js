...
export const marketsLinks = [
  { to: '/markets', label: 'Markets overview', desc: 'Gold, crypto and NEPSE', icon: 'LineChart' },
  { to: '/gold', label: 'Gold & Silver', desc: 'Nepal and international rates', icon: 'Coins' },
...
export const mainNav = [
  ...
  { label: 'Explore', children: weatherLinks, match: ['/weather', '/where-to-go', '/explore-nepal'] },
  ...
  { label: 'Markets', children: marketsLinks, match: ['/markets', '/gold', '/crypto', '/nepse'] },
...
export const DOMAINS = [
  ...
  ['markets', ['/markets', '/gold', '/crypto', '/nepse']],
  ['nepal', ['/weather', '/where-to-go', '/explore-nepal']],
  ['tools', ['/tools', '/bmi']],
  ['fun', ['/astrology', '/tarot']],
